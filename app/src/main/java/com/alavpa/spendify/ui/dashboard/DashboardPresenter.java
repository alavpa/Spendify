...
public class DashboardPresenter extends BasePresenter<DashboardView>{
    ...
    public void populateOutcome(){
        ...
        AmountBar.AmountBarPart outcome1 = new AmountBar.AmountBarPart(0.5f,resourceProvider.getColor(R.color.cyan));
        AmountBar.AmountBarPart outcome2 = new AmountBar.AmountBarPart(0.5f,resourceProvider.getColor(R.color.amber));
    ...
    public void populateIncome(){
        ...
        AmountBar.AmountBarPart income1 = new AmountBar.AmountBarPart(1.0f,resourceProvider.getColor(R.color.blue));
        income.add(income1);
